...
operationsRouter.get('/enquiries', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
operationsRouter.post('/enquiries', async (req: Request, res: Response, next: NextFunction) => {
  try {
    if (!req.userId) throw new UnauthorizedError();
...
operationsRouter.put('/enquiries/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    if (!req.userId) throw new UnauthorizedError();
...
operationsRouter.get('/routines', async (req: Request, res: Response, next: NextFunction) => {
  try {
    if (!req.userId) throw new UnauthorizedError();
...
operationsRouter.post('/routines', async (req: Request, res: Response, next: NextFunction) => {
  try {
    if (!req.userId) throw new UnauthorizedError();
