...
export async function listInsights(userId: string): Promise<AIInsight[]> {
...
export async function regenerateInsights(userId: string): Promise<AIInsight[]> {
  ...
  const studentMetrics = await query<any>(
